        ...
        ScrollView {
            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading) {
                    ...
                    Text("**NOTE**: We can also specify options for the animation effect by passing in the options parameter. \nEx: `.transition(.symbolEffect(.drawOn, options: .speed(5)))` \nNot all options will have effect, for example, setting it to `repeat(count)` will not make the animation to repeat.")
                        .font(.caption)
